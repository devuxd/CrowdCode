<!doctype html> <html class="no-js"> <head><script>var projectId    = '<%=(String) request.getAttribute("project") %>';</script> <meta charset="utf-8"> <title></title> <meta name="description" content=""> <meta name="viewport" content="width=device-width"> <!-- Place favicon.ico and apple-touch-icon.png in the root directory --> <link rel="stylesheet" href="/dist/styles/vendor.412e7e63.css"> <link rel="stylesheet" href="/dist/styles/main.73282ec8.css">  <body ng-app="crowdAdminApp"> <!--[if lt IE 7]>
    ...
    <![endif]--> <script charset="utf-8" src="/dist/scripts/vendor.6b4e371c.js"></script> <script charset="utf-8" src="/dist/scripts/scripts.edf5a0cd.js"></script> <script type="text/javascript">(function () {
