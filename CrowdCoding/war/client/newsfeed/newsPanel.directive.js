angular
    .module('crowdCode').directive('newsPanel',function($rootScope,$timeout,firebaseUrl, workerId, questionsService, functionsService, FunctionFactory, microtasksService, newsfeedService){
    	return {
		scope: {},
