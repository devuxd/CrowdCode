...
angular.module("data_types/adt_list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("data_types/adt_list.html",
    ...
    "                            bs-options=\"example.name for example in ADT.examples\" >\n" +
    "                    </button>\n" +
    "                    <span class=\"clearfix\"></span>\n" +
...
angular.module("microtasks/microtask_title.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("microtasks/microtask_title.html",
    ...
    "		<span class=\"tutorial-btn glyphicon glyphicon-question-sign color\" ng-click=\"$emit('queue-tutorial', microtask.type, true); \"></span>\n" +
    "		<span class=\"clearfix\"></span>\n" +
    "</div>");
}]);
...
angular.module("microtasks/write_call/write_call.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("microtasks/write_call/write_call.html",
    ...
    "\n" +
    "\n" +
    "	<div ng-show=\"microtask.reissuedSubmission !== undefined\" ng-include=\"'/client/microtasks/reissue_microtask.html'\"></div>\n" +
    "	\n" +
    "	<div class=\"section section-description\">\n" +
    "		<div class=\"section-title\" >\n" +
    "			<div class=\"dot bg-color\"></div> FUNCTION DESCRIPTION\n" +
...
angular.module("microtasks/write_function/write_function.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("microtasks/write_function/write_function.html",
    ...
    "				<strong>TIP:</strong> If there’s a lot to do, be sure to use function stubs and/or pseudocode to leave some work for others\n" +
    "			</div>\n" +
...
angular.module("microtasks/write_test/write_test.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("microtasks/write_test/write_test.html",
    ...
    "	</div>\n" +
    "\n" +
    "	<div ng-if=\"microtask.reissuedSubmission !== undefined\" ng-include=\"'/client/microtasks/reissue_microtask.html'\"></div>\n" +
    "\n" +
    "	\n" +
...
angular.module("questions/questionForm.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("questions/questionForm.html",
    ...
    "					<input type=\"text\" class=\"form-control\" name=\"title\" ng-model=\"question.title\" placeholder=\"insert title\" required>\n" +
    "					<div ng-if=\"questionForm.title.$dirty\" ng-messages=\"questionForm.title.$error\" style=\"color:maroon\" role=\"alert\">\n" +
    "						<div ng-message=\"required\">the 'title' field is required!</div>\n" +
    "					</div>\n" +
    "				</div>\n" +
    "				<div class=\"form-group\">\n" +
    "					<label for=\"text\">Text</label>\n" +
    "					<textarea name=\"text\" class=\"form-control\" style=\"resize:none;height:300px\" ng-model=\"question.text\" placeholder=\"insert text\"></textarea>\n" +
    "				</div>\n" +
    "				<div class=\"form-group\">\n" +
    "					<label for=\"\">Tags (separate tags with comma) </label>\n" +
    "					<div><span ng-repeat=\"tag in question.tags\" class=\"tag\">{{tag}} <span ng-click=\"removeTag(tag)\">x</span></span></div>\n" +
    "					\n" +
...
angular.module("tutorials/main.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("tutorials/main.html",
    ...
    "	<div class=\"text\" >\n" +
    "		<div class=\"pull-left\">\n" +
    "			<img src=\"/img/tutorial/main/question1.png\" style=\"width:350px;margin-right:10px;\"/>\n" +
    "		</div>\n" +
    "		<div style=\"pull-left\">\n" +
    "			<p>\n" +
    ...
    "			</p>\n" +
    "			<p>If you can't find what you’re looking for, you can <strong>ask a question</strong>.</p>\n" +
    "		</div>\n" +
    "		<span class=\"clearfix\"></span>\n" +
    "	</div>\n" +
    "</step>\n" +
    ...
    "	<div class=\"text\">\n" +
    "		<div class=\"pull-left\">\n" +
    "			<img src=\"/img/tutorial/main/question2.png\" style=\"width:350px;margin-right:10px;\"/>\n" +
    "		</div>\n" +
    ...
    "	<div class=\"text\">\n" +
    "		<div class=\"pull-left\">\n" +
    "			<img src=\"/img/tutorial/main/question3.png\" style=\"width:350px;margin-right:10px;\"/>\n" +
    "		</div>\n" +
    "		<div class=\"pull-left\" style=\"width:200px\">\n" +
    "			<p>\n" +
...
angular.module("widgets/left_bar_template.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("widgets/left_bar_template.html",
    ...
    "    <ul class=\"nav\" role=\"\">\n" +
    "    	<li id=\"{{tab}}Btn\" class=\"{{ selectedTab == $index ? 'active': '' }} {{ $index == 0 ? 'first' : '' }}\" ng-repeat=\"tab in tabs track by $index\" ng-click=\"selectTab($index)\">{{tab}}</li>\n" +
    "    </ul>\n" +
    "  </div>\n" +
    "\n" +
    "  <div class=\"tab-content\" id=\"leftTab\">\n" +
    "    <news ng-show=\"selectedTab == 0\"></news>\n" +
    "    <questions-panel ng-show=\"selectedTab == 1\"></questions-panel>\n" +
    "    <leaderboard ng-show=\"selectedTab == 2\"></leaderboard>\n" +
    "    <!--<chat ng-show=\"selectedTab == 3\"></chat>-->\n" +
    "  </div>\n" +
    "\n" +
    "</div>\n" +
    "<!--\n" +
