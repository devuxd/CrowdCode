    ...
    %>
        ...
        <link
        href='https://fonts.googleapis.com/css?family=Merriweather:300normal,300italic,400normal,400italic,700normal,700italic,900normal,900italic|Lato:100normal,100italic,300normal,300italic,400normal,400italic,700normal,700italic,900normal,900italic'
        rel='stylesheet' type='text/css'>

        <!-- Stylesheets -->
        <link rel="stylesheet" href="/include/bootstrap/css/bootstrap.min.css" type="text/css" />
        <link rel="stylesheet" href="/include/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css"
        type="text/css" />
        ...
        <script src="/clientDist/test_runner/deepCompare.js"></script>
        ...
        <span onload="alertName();">wsfafsfasf</span>
